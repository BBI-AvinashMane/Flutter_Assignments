...
//   List<ProductEntity> _productCache = [];
...
//   Future<void> _onGetProductEvent(GetProductEvent event, Emitter<ProductState> emit) async {
//     emit(ProductLoading());

//     if (_productCache.isNotEmpty) {
//       emit(ProductLoaded(_productCache));
//       return;
//     }
...
//   void _onGetProductDetailsEvent(GetProductDetailsEvent event, Emitter<ProductState> emit) {
//     try {
//       final product = _productCache.firstWhere((p) => p.id == event.productId);
//       emit(ProductLoaded([product]));
//     } catch (e) {
//       emit(ProductError('Product not found'));
//     }
